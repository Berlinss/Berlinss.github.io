...
let URL = {};
URL.blog =
  'https://www.cnblogs.com/berlinss/';
URL.ryanfloyd = '';  // 个人站点
URL.fund = '';
URL.gitee = 'https://gitee.com/Berlinss/';
URL.BiliBili = 'https://space.bilibili.com/256628729';
URL.email = '';
URL.music = '';
URL.devTo =  // 跳转QQ
  'http://wpa.qq.com/msgrd?v=3&uin=2682972529&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:2682972529:41';
// '';
